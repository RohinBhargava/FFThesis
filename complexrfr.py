import sklearn.ensemble, sklearn.model_selection, sys, common, commongbg
...
for i in range(len(PARAMS[pos])):
    ...
    lr = sklearn.model_selection.GridSearchCV(sklearn.ensemble.RandomForestRegressor(), {'max_depth':[5, 8], 'min_samples_split':[5, 10], 'min_samples_leaf':[5,10], 'max_leaf_nodes':[100, 200]}, n_jobs=-1, cv=5)
