...
for i in range(len(PARAMS[pos])):
    ...
    lr = sklearn.model_selection.GridSearchCV(sklearn.ensemble.GradientBoostingRegressor(), {'learning_rate':[0.01, 0.1, 1], 'max_depth':[1, 2, 3], 'min_samples_split':[2, 5, 10]}, n_jobs=-1, cv=5)
