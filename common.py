...
TOP_FIVE = {'QB' : ['BradTo00', 'WilsRu00', 'WentCa00', 'BreeDr00', 'RodgAa00'], 'RB' : ['BellLe00', 'GurlTo01', 'ElliEz00', 'KamaAl00', 'HuntKa00'], 'WR' : ['BrowAn04', 'BeckOd00', 'JoneJu02', 'HopkDe00', 'ThomMi05'], 'TE' : ['GronRo00', 'KelcTr00', 'ErtzZa00', 'EngrEv00', 'GrahJi00']}
YEAR_ST = 2010
YEAR_END = 2018
...
def parsePl(year, tsd, n, pos):
    ...
    for i in range(len(ycodes)):
        if y['FantPos'][i] == pos:
            player = ycodes[i]
            namgam[player] = (np.float32(games.ix[i][0]), games.ix[i][1])
